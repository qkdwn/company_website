    ...
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {servicesList.map((service) => (
          <div
            key={service.id}
            className="bg-white p-8 rounded-lg shadow-lg hover:-translate-y-2 transition-transform duration-300 text-left"
          >
            <div className="text04xl mb-4">{service.icon}</div>
      ...
      <div classnName="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">연중 무휴 기술지원 서비스</p>
          </div>
        </div>
      </div>

      <div className="mt-32">
        <h2 className="text-3xl font-bold text-grayy-800 mb-12 text-center">프로젝트 진행 프로세스</h2>
